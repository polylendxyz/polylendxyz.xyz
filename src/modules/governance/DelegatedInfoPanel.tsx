            ...
            {!isAaveSelfDelegated && (
              ...
              >
                <Box sx={{ display: 'flex', gap: 2, alignItems: 'center' }}>
                  <TokenIcon symbol="PLEND" sx={{ width: 16, height: 16 }} />
    ...
    <Paper sx={{ mt: 2 }}>
      <Box sx={{ px: 6, pb: 6, pt: 4 }}>
        ...
        <Typography typography="description" sx={{ mt: 1 }} color="text.secondary">
          <Trans>
            Use your PLEND and stkAAVE balance to delegate your voting and proposition powers. You
        ...
        {disableButton ? (
          <Typography variant="description" color="text.muted" mt={6}>
            <Trans>You have no PLEND/stkAAVE balance to delegate.</Trans>
          </Typography>
        ) : (
          <>
            <DelegatedPower
