  ...
  return (
    <>
      <AnalyticsConsentBanner
        ...
        buttonStyle={{
          background: theme.palette.mode === 'dark' ? '#F7F7F9' : '#333',
          color: theme.palette.mode === 'dark' ? '#333' : '#F7F7F9',
        ...
        declineButtonStyle={{
          // background:  '#F7F7F9',
          background: theme.palette.mode === 'dark' ? '#333' : '#F7F7F9',
          color: theme.palette.mode === 'dark' ? '#EAEBEF' : '#333',
          ...
          margin: '10px',
          // padding: '10px 20px',
          border: `1px solid ${theme.palette.mode === 'dark' ? '#333' : '#EAEBEF'}`,
          width: '172px',
          height: '36px',
          // padding: '0px',
          cursor: 'pointer',
