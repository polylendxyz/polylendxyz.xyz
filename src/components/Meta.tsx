...
export function Meta({ title, description, imageUrl, timestamp }: MetaProps) {
  return (
    <Head>
      <title>PolyLend - {title}</title>
      <meta name="description" content={description} key="description" />
      <meta property="og:title" content={`PolyLend - ${title}`} key="title" />
      ...
      <meta name="twitter:site" content="@polylendxyz" key="twittersite" />
      <meta
      ...
      />
      <meta name="apple-mobile-web-app-title" content={`PolyLend`} />
