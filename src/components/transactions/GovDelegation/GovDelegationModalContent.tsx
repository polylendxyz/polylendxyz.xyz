...
export const GovDelegationModalContent: React.FC<GovDelegationModalContentProps> = ({ type }) => {
  ...
  const tokens = [
    ...
    },
    {
      ...
      type: DelegationTokenType.PLEND,
    },
  ];
      ...
      {isRevokeModal ? (
        ...
        >
          <Trans>
            ...
            your PLEND or stkAAVE balance. Your tokens will remain in your account, but your
            delegate will be able to vote or propose on your behalf. If your PLEND or stkAAVE
